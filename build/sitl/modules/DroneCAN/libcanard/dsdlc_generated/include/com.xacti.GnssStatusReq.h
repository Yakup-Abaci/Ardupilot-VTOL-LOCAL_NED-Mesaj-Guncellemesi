...
static inline void _com_xacti_GnssStatusReq_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_xacti_GnssStatusReq* msg, bool tao);
...
void _com_xacti_GnssStatusReq_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_xacti_GnssStatusReq* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
